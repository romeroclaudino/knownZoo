...
SnifferPacketT* snifferP = NULL;
char addr[] = "00:00:00:00:00:00";

String rssids[QTD_MACS];

int contadorMac = 0;
char macs[QTD_MACS][18];
...
#define ENABLE  1
 ...
 void timer2(){
  if(contador > 2){
    ...
    Serial.println("Desarmado e Sem promiscuo.");
    setup_wifi();
